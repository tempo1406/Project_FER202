              ...
              >
                  ...
                  >
                      ...
                      <ul>
                          ...
                          <li className='font-medium text-sm text-violet-500 hover:text-violet-700 dark:hover:text-violet-400 flex items-center py-1 px-3 hover:cursor-pointer' onClick={handleLogout}>
