        ...
        <main className='grow'>
          <div className='w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl'>
            ...
            <div className='max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg dark:bg-gray-800'>
              {/* Information Section */}
              <div className='mb-6'>
                <h2 className='text-xl font-semibold mb-4 dark:text-gray-100'>Information</h2>
              ...
              <div>
                <h2 className='text-xl font-semibold mb-4 dark:text-gray-100'>Customer Address</h2>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                  <div>
                    <label
                      className='block text-sm font-medium mb-2 dark:text-gray-100'
