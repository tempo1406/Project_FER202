...
import TabClass from '../components/TabClass'; // Import your TabClass component
            ...
            <div className='relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto'>
                ...
                <main className='grow'>
                    <div className='w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl'>
                        ...
                        {/* Conditional Rendering of TabClass */}
                        {activeTab === 'class' && (
                            <TabClass onTabChange={handleTabChange} />
                        )}
                    </div>
                </main>
            </div>
